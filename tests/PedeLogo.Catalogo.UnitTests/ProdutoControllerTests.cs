...
namespace PedeLogo.Catalogo.UnitTests
{
    public class ProdutoControllerTests
    {
        ...
        public ProdutoControllerTests()
        {
            ...
            _dbMock.Setup(db => db.GetCollection<Produto>("Produto", null)).Returns(_collectionMock.Object);
        ...
        public void Post_ComProdutoValido_DeveRetornarOk()
        {
            ...
            _collectionMock.Setup(c => c.InsertOne(produto, null, default)).Verifiable();
        ...
        {
            var act = () => _controller.Put("nao-e-objectid", new Produto { Nome = "Teste" });
            act.Should().Throw<System.Exception>().WithMessage("Id errado");
        }
        ...
        public void Put_ComIdValido_DeveChamarFindOneAndReplace()
        {
            ...
            _collectionMock.Setup(c => c.FindOneAndReplace(It.IsAny<FilterDefinition<Produto>>(), produto, It.IsAny<FindOneAndReplaceOptions<Produto, Produto>>(), It.IsAny<CancellationToken>())).Returns(produto);
        ...
        {
            var id = ObjectId.GenerateNewId().ToString();
            _collectionMock.Setup(c => c.FindOneAndDelete(It.IsAny<FilterDefinition<Produto>>(), It.IsAny<FindOneAndDeleteOptions<Produto, Produto>>(), It.IsAny<CancellationToken>())).Returns((Produto)null);
            var act = () => _controller.Delete(id);
            act.Should().NotThrow();
        }

        private Mock<IAsyncCursor<Produto>> CriarCursorMock(List<Produto> produtos)
        {
